      ...
      >
        ...
        >
          <Row justify={"space-between"} align="middle">
            ...
            <Col style={{}}>
              <Title style={{ margin: "0px", fontSize: "17px", color: "#057cbd" }}>
                Sri Murugan Mobiles
              </Title>
                  ...
                  <>
                    ...
                    <Table.Summary.Row>
                      ...
                      <Table.Summary.Cell index={10} align="right">
                        <strong>₹{pdfData?.totalAmount.toLocaleString("en-IN")}</strong>
                      </Table.Summary.Cell>
                    </Table.Summary.Row>
                  </>
                );
                  ...
                  <Row style={{ lineHeight: "10px", height: "51px" }}>
                    <Col span={24}>
                      ...
                      <Text style={{ fontSize: "11px" }}>
                        1. The items must be collected within 7 days; otherwise, the organization is not liable for any loss or damage.
                      </Text>
                      <br />
                      <Text style={{ fontSize: "11px" }}>
                    ...
                    <Row>
                      ...
                      >
                        <Text style={{ lineHeight: "3px", fontSize: "11px" }}>
                          I authorize the service provider to perform the requested repairs/services on my device and agree to the terms and conditions.
                        </Text>
                        <br />
                        <br />
                        <br />
                        ...
                        <Text style={{ fontSize: "12px", marginTop: "10px", fontWeight: "500" }}>
                ...
                <Card className="invoice-card" style={{ marginTop: 4, height: "130px" }}>
                  <Col span={24}>
                    <Row>
                      ...
                      >
                        <Text style={{ lineHeight: "3px", fontSize: "11px" }}>
                          We agree to perform the requested repairs/services as per the terms and conditions provided to the customer.
                        </Text>
                        <br />
