...
const ServiceInvoicePdf = (props) => {
  ...
  useEffect(() => {
    ...
    const adjustedData = [
      {
        srNo: 1,
        productName: `${props?.pdfData?.productName} ${
          props.pdfData.imeiNumber ? "IMEI: " + props.pdfData.imeiNumber : ""
        }`,
        total: props?.pdfData?.customerCost,
        advance: props?.pdfData?.advancePayment,
      },
      {},
      {},
      {},
                  ...
                  <Col justify={"space-between"}>
                    <Row>
                      <Col span={24}>
                        <Text>
                          <strong>Name:</strong>{" "}
                          {props?.pdfData?.customer?.name}
                        </Text>
                      </Col>
                      <Col span={24}>
                        <Text>
                          <strong>Address:</strong>{" "}
                          {props?.pdfData?.customer?.address}
                        </Text>
                      </Col>
                      <Col span={12}>
                        <Text>
                          <strong>State:</strong>{" "}
                          {props?.pdfData?.customer?.state}
                        </Text>
                      </Col>
                      <Col span={12}>
                        <Text>
                          <strong>Pin code:</strong>{" "}
                          {props?.pdfData?.customer?.pinCode}
                        </Text>
                      </Col>
                      <Col span={24}>
                        <Text>
                          <strong>Phone:</strong>{" "}
                          {props?.pdfData?.customer?.phoneNumber}
                        </Text>
                      </Col>
                    </Row>
                  </Col>
              ...
              >
                ...
                >
                  <Row>
                    <Col span={24}>
                      <Text>
                        <strong>Invoice No:</strong> {props.pdfData?.invoiceNumber}
                      </Text>
                    </Col>
                    <Col span={24}>
                      <Text>
                        <strong>Invoice Date:</strong>{" "}
                        {IndianDateTimeFormate(props.pdfData?.serviceDate)}
                      </Text>
                    </Col>
                    <Col span={24}>
                      <Text>
                        <strong>Advance:</strong>₹
                        {props.pdfData?.advancePayment}
                      </Text>
                    </Col>
                    <Col span={24} style={{ padding: "11.7px" }}></Col>
                  </Row>
                </Card>
              </ConfigProvider>
            </Col>
                  ...
                  <Row justify={"space-between"} style={{ height: "28px" }}>
                    ...
                    <Col>
                      <Text style={{ paddingRight: "5px" }}>
                        <strong>
                          ₹
                          {props?.pdfData?.customerCost?.toLocaleString(
                            "en-IN"
                          )}
                        </strong>
                      </Text>
