...
// class InvoiceBillClass extends TableParentPage {
//   constructor() {
//     super();
//     this.state = {
//       paymentType: ["CASH"],
...
//                       <div>
//                         ₹{" "}
//                         {this.formatIndianNumber(
//                           this.form?.getFieldValue("pricePerUnit") || 0
//                         )}
//                       </div>
//                     </Flex>
//                   </Col>
...
//                         ₹{" "}
//                         {this.formatIndianNumber(
//                           this.form?.getFieldValue("igstAmount") || 0
//                         )}
//                       </div>
//                     </Flex>
//                   </Col>
...
//                         ₹{" "}
//                         {this.formatIndianNumber(
//                           this.form?.getFieldValue("cgstAmount") || 0
//                         )}
//                       </div>
//                     </Flex>
//                   </Col>
...
//                         ₹{" "}
//                         {this.formatIndianNumber(
//                           this.form?.getFieldValue("sgstAmount") || 0
//                         )}
//                       </div>
//                     </Flex>
//                   </Col>
...
//                         ₹{" "}
//                         {this.formatIndianNumber(
//                           this.form?.getFieldValue("totalTaxAmount") || 0
//                         )}
//                       </div>
//                     </Flex>
//                   </Col>
...
//                         ₹{" "}
//                         {this.formatIndianNumber(
//                           this.form?.getFieldValue("totDiscountAmount") || 0
//                         )}
//                       </div>
//                     </Flex>
//                   </Col>
...
//                     <Flex justify="space-between" style={{ fontWeight: "600" }}>
//                       <div>Round off</div>
//                       <div>₹ {this.form?.getFieldValue("roundOff") || 0}</div>
//                     </Flex>
//                   </Col>
//                   <Col span={24}>
//                     <hr
...
//                         ₹{" "}
//                         {this.formatIndianNumber(
//                           this.form?.getFieldValue("totalAmount") || 0
//                         )}
//                       </div>
//                     </Flex>
//                   </Col>
      ...
      <Spin spinning={this.state.isLoading}>
        <Form
          ...
          onValuesChange={(changedValues, allValues) => {
            ...
            if (changedIndex !== -1) {
              ...
              const selectedProduct = this.state.productList?.find(
                (p) =>
                  ...
                  changedItem?.product?.identity?.toLowerCase()
              );

              if (selectedProduct) {
                const product = { id: selectedProduct.id, state: true };
                const pricePerUnit = selectedProduct.sellingPrice || 0;
                const quantity = changedItem.quantity || 1;
                const discountAmount = Number(changedItem.discountAmount || 0);
                const quantityPrice = quantity * pricePerUnit;
            ...
            console.log("updatedLineItemsupdatedLineItems", updatedLineItems);
        ...
        >
          <Row gutter={[10, 10]}>
            <Col xs={24} lg={16}>
              ...
              >
                <Link to="/sales-and-billing/invoice/history">
                  <Flex>
                    <ArrowLeftOutlined />
                        ...
                        columns={[
                          {
                            ...
                            render: (_, field) => (
                              <>
                                <Form.Item
                                  {...field}
                                  name={[field.name, "product", "identity"]}
                                  style={{ margin: 0 }}
                                >
                                  <AutoComplete
                                    value={this.state.searchValue} // Bind the search value for the input
                                    options={
                                            ...
                                            .filter(
                                              (product) =>
                                                product.identity
                                                  ...
                                                  ) // Filter only if searchValue exists
                                            )
                                            .slice(0, 5) // Limit to the first 5 results
                                            .map((product) => ({
                                              value: product.identity, // Populate the options with filtered identities
                                            }))
                                        : this.state.productList
                                            ?.slice(0, 5)
                                            .map((product) => ({
                                              value: product.identity, // Show all options, limited to 5
                                            }))
                                    }
                                    ...
                                    onSearch={(value) => {
                                      this.setState({ searchValue: value }); // Update searchValue on typing
                                    }}
                                  />
                                </Form.Item>
                                <Form.Item
                                ...
                                >
                                  <Select
                                    options={this.state.productList?.map(
                                      (e) => ({
                                        value: e.id,
                                        label: e.productName,
                                      })
